...
# Formulation where capacity is in terms of number of customers
prob = pulp.LpProblem("Cust_CFLP", pulp.LpMinimize)
...
print("Objective value (Cust Capacity Formulation):", pulp.value(prob.objective))
